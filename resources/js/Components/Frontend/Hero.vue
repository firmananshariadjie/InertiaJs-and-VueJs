        ...
        <div class="container mx-auto h-full">
            <div class="flex flex-col md:flex-row items-center h-full pt-8">
                <div class="flex-1 flex flex-col items-center lg:items-start">
                    ...
                    <h1
                        class="text-4x1 leading-[44px] md:text-5xl md:leading-tight lg:text-7xl lg:leading-[1.2] font-bold md:tracking-[-2px]"
                    >
                        I Build & Design " <br />
                        Web Interfaces.
                    </h1>
                ...
                >
                    <img
                        class="rounded-lg"
                        src="http://127.0.0.1:8000/img/work.jpg"
                        alt="Hero"
                    />
                </div>
            </div>
